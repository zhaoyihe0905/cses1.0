...
insert into tb_interfaces (id, bussiness_desc, inconfig_field, outconfig_field, remark, valid_status, xml_name, url) values (1, '投保查询', '<user>', '<user>', '', '1', 'D:feiqAutoRecv Files许健(1CB72C117CC2)交强险V6.2.0测试工具scXMLinsurequery.xml', 'localhost:8080/');
insert into tb_interfaces (id, bussiness_desc, inconfig_field, outconfig_field, remark, valid_status, xml_name, url) values (2, '投保预确认', '<user>', '<user>', '', '1', 'D:feiqAutoRecv Files许健(1CB72C117CC2)交强险V6.2.0测试工具scinsureconfirm.xml', 'localhost:8080/');
insert into tb_interfaces (id, bussiness_desc, inconfig_field, outconfig_field, remark, valid_status, xml_name, url) values (3, '投保查询校验', '<user>', '<user>', '', '1', 'D:feiqAutoRecv Files许健(1CB72C117CC2)交强险V6.2.0测试工具scyuquef.xml', 'localhost:8080/');
insert into tb_interfaces (id, bussiness_desc, inconfig_field, outconfig_field, remark, valid_status, xml_name, url) values (4, '投保注销', '<user>', '<user>', '', '1', 'D:feiqAutoRecv Files许健(1CB72C117CC2)交强险V6.2.0测试工具sczhuxiao.xml', 'localhost:8080/');
